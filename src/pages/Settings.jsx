...
export default function Settings() {
  ...
  function saveGoogleClientId() {
    if (googleClientId.trim()) {
      localStorage.setItem('lifeos_google_client_id', googleClientId.trim())
    } else {
      localStorage.removeItem('lifeos_google_client_id')
    }
  ...
  return (
    <div style={{ maxWidth: '920px', margin: '0 auto' }}>
      ...
      <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <Card>
          {sectionTitle(<KeyRound size={18} />, 'API Configuration', 'Configure API keys for external services.')}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  {googleClientId ? (
                    ...
                    <span style={{ fontSize: '11px', color: '#F43F5E', display: 'flex', alignItems: 'center', gap: '4px' }}>
              ...
              {isEditingGoogle ? (
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 12px', background: 'var(--bg-secondary)', borderRadius: '10px', border: '1px solid var(--border)' }}>
                  <div style={{ fontSize: '13px', color: 'var(--text-primary)', fontFamily: 'monospace' }}>
                    {googleClientId ? maskKey(googleClientId) : 'Not set'}
                  </div>
                  <Button variant="secondary" onClick={() => setIsEditingGoogle(true)}>Edit</Button>
                </div>
              )}
            </div>
            ...
            <div>
              ...
              {isEditingGemini ? (
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 12px', background: 'var(--bg-secondary)', borderRadius: '10px', border: '1px solid var(--border)' }}>
                  <div style={{ fontSize: '13px', color: 'var(--text-primary)', fontFamily: 'monospace' }}>
                    {geminiKeyInput ? maskKey(geminiKeyInput) : 'Not set'}
                  </div>
                  <div style={{ display: 'flex', gap: '8px' }}>
                    <Button variant="secondary" onClick={testGeminiKey}>Test</Button>
                    <Button variant="secondary" onClick={() => setIsEditingGemini(true)}>Edit</Button>
                  </div>
                </div>
              )}
              {apiStatus && (
            ...
            <div>
              <button
                ...
                style={{ background: 'none', border: 'none', color: 'var(--accent-indigo)', fontSize: '12px', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px', padding: 0 }}
              >
                <Info size={14} /> How to get these?
              </button>
              
              {showApiHelp && (
                <div style={{ marginTop: '10px', padding: '12px', background: 'rgba(99,102,241,0.1)', borderRadius: '8px', border: '1px solid rgba(99,102,241,0.2)', fontSize: '12px', color: 'var(--text-secondary)', lineHeight: 1.5 }}>
                  <strong style={{ color: 'var(--text-primary)' }}>Google Client ID:</strong><br />
                  1. Go to Google Cloud Console<br />
                  2. Create a project and enable Google Drive API<br />
                  3. Create OAuth 2.0 Web Application credentials<br />
                  4. Add your domain to Authorized JavaScript origins and redirect URIs<br />
                  <br />
                  <strong style={{ color: 'var(--text-primary)' }}>Gemini API Key:</strong><br />
                  Go to Google AI Studio (aistudio.google.com) to generate a free API key.
                </div>
              )}
            </div>
          </div>
